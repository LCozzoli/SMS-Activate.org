...
(function (EActivationSetStatus) {
    EActivationSetStatus[EActivationSetStatus["Ready"] = 1] = "Ready";
...
})(EActivationSetStatus || (exports.EActivationSetStatus = EActivationSetStatus = {}));
...
})(EActivationSetStatusAnswer || (exports.EActivationSetStatusAnswer = EActivationSetStatusAnswer = {}));
...
(function (EActivationGetStatusAnswer) {
    ...
    EActivationGetStatusAnswer["STATUS_UNEXPECTED"] = "Unexpected status response";
})(EActivationGetStatusAnswer || (exports.EActivationGetStatusAnswer = EActivationGetStatusAnswer = {}));
...
})(EIncomingCallStatus || (exports.EIncomingCallStatus = EIncomingCallStatus = {}));
var ERentalSatus;
(function (ERentalSatus) {
    ERentalSatus[ERentalSatus["Finish"] = 1] = "Finish";
    ERentalSatus[ERentalSatus["Cancel"] = 2] = "Cancel";
})(ERentalSatus || (exports.ERentalSatus = ERentalSatus = {}));
