...
const activations_1 = require("./lib/parts/activations/activations");
const rental_1 = require("./lib/parts/rental/rental");
const utils_1 = require("./lib/parts/utils/utils");
const countries_1 = require("./lib/parts/utils/countries");
const query_module_1 = require("./lib/query/query.module");
let Base = class Base {
    constructor(apiKey, query, countries, utils) {
        this.apiKey = apiKey;
        this.query = query;
