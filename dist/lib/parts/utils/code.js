...
class waitForCode {
    waitForCode(id, tries = 60) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                while (tries--) {
                    const result = yield this.getStatus(id);
                    if (result.code == status_1.EActivationGetStatusAnswer.STATUS_OK)
                        return resolve(result.data);
                    if (result.code != status_1.EActivationGetStatusAnswer.STATUS_WAIT_CODE)
                        return reject(result);
                    (0, helpers_1.sleep)(1000);
                }
            }));
        });
    }
