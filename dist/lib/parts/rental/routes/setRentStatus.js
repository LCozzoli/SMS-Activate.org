...
exports.setRentStatus = void 0;
const comon_1 = require("../../../../ressources/comon");
const errors_1 = require("../../../../ressources/errors");
class setRentStatus {
    setRentStatus(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                var _a;
                (_a = this.query) === null || _a === void 0 ? void 0 : _a.makeCall(comon_1.EApiActions.setRentStatus, options).then((response) => {
...
exports.setRentStatus = setRentStatus;
//# sourceMappingURL=setRentStatus.js.map